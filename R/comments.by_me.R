...
##' 
##' @title Return comments posted by the authenticating user.
...
##' @references \url{http://open.weibo.com/wiki/2/comments/by_me}
##' @keywords Comments
##' @examples \dontrun{
##' 
...
comments.by_me <- function(roauth, count = 20, page = 1, filter_by_source = 0, ...) {
	requestURL <- "https://api.weibo.com/2/comments/by_me.json"
	funCall <- match.call()
