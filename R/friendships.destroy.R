...
##' @references \url{http://open.weibo.com/wiki/2/friendships/destroy}
##' @keywords Friendships
##' @examples \dontrun{
##' 
##' friendships.destroy(roauth, screen_name = "lijian001")
##' }

friendships.destroy <- function(roauth, uid, screen_name, ...) {
	requestURL <- "https://api.weibo.com/2/friendships/destroy.json"
	funCall <- match.call()
