...
##' 
##' @title Return the latest weibos of the authenticating user and his friends.
...
##' @references \url{http://open.weibo.com/wiki/2/statuses/friends_timeline}
##' @keywords Weibo
##' @examples \dontrun{
##' 
##' statuses.friends_timeline(roauth, count = 5)
##' }

statuses.friends_timeline <- function(roauth, count = 20, page = 1, base_app = 0, feature = 0, ...) {
	requestURL <- "https://api.weibo.com/2/statuses/friends_timeline.json"
	funCall <- match.call()
